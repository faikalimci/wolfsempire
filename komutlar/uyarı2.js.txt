...
exports.run = async (client, message, args) => {
  ...
  let UyarıSeviyesi1  = '630737714622496798';
...
if (!user) return msg.reply('Kime Ceza rolü vercem!')
  ...
  if (member.roles.has(UyarıSeviyesi2)) return msg.reply(uyarı)
  
  member.removeRole(UyarıSeviyesi1)
  member.addRole(UyarıSeviyesi2)
